...
echo ""
echo "If the app doesn't appear in the Overview, you may need to log out and" 
echo "back in after installation so that GNOME Shell picks up the new .desktop file."
